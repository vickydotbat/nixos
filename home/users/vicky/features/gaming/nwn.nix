...
let
  ...
  # installNwnSettingsFile =
  #   file:
  #   let
  #     source = ./nwn-settings/${file};
  #   in
  #   ''
  #     settings_target="$nwn_data_dir/${file}"

  #     if [[ -L "$settings_target" ]]; then
  #       $DRY_RUN_CMD ${pkgs.coreutils}/bin/rm "$settings_target"
  #     fi

  #     if [[ ! -e "$settings_target" ]]; then
  #       $DRY_RUN_CMD ${pkgs.coreutils}/bin/install -m 0644 ${source} "$settings_target"
  #     fi
  #   '';
in
{
